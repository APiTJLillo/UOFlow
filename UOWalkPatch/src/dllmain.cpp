...
// The client uses __stdcall for RegisterLuaFunction. The argument order is
// (lua_State*, functionPtr, name). Our hook must match this exactly.
typedef void (__stdcall* RegisterLuaFunction_t)(void*, void*, const char*);
