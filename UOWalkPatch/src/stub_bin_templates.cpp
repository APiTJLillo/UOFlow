...
const unsigned char hook_stub_template[] = {
    ...
    0x8B, 0x4D, 0x08,                // mov ecx, [ebp+8]    ; first arg is lua state
    0x89, 0x08,                       // mov [eax], ecx
    // skip_lua:
    
    // Call original function with exact same args
    0xFF, 0x75, 0x10,                // push dword [ebp+10h] ; arg3
    0xFF, 0x75, 0x0C,                // push dword [ebp+0Ch] ; arg2
    0xFF, 0x75, 0x08,                // push dword [ebp+08h] ; arg1 (lua state)
    0xB8, 0x00, 0x00, 0x00, 0x00,    // mov eax, RegisterLuaFunction
    0xFF, 0xD0,                       // call eax
    0x83, 0xC4, 0x0C,                // add esp, 0Ch        ; clean up 3 args
    
    // Epilogue - exactly matching original
    0x5F,                            // pop edi
    0x5E,                            // pop esi
    0x5B,                            // pop ebx
    0x89, 0xEC,                      // mov esp, ebp
    0x5D,                            // pop ebp
    0xC2, 0x0C, 0x00                 // ret 0Ch             ; cdecl with 3 args
};
